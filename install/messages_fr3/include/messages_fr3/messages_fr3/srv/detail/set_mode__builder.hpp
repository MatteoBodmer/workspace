...
class Init_SetMode_Response_error_message
{
public:
  explicit Init_SetMode_Response_error_message(::messages_fr3::srv::SetMode_Response & msg)
  : msg_(msg)
  {}
  ::messages_fr3::srv::SetMode_Response error_message(::messages_fr3::srv::SetMode_Response::_error_message_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetMode_Response_error_message success(::messages_fr3::srv::SetMode_Response::_success_type arg)
  {
    msg_.success = std::move(arg);
    return Init_SetMode_Response_error_message(msg_);
  }
