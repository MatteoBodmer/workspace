...
static const _SetParam_Request_type_support_symbol_names_t _SetParam_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages_fr3, srv, SetParam_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, messages_fr3, srv, SetParam_Request)),
  }
};
...
get_message_type_support_handle<messages_fr3::srv::SetParam_Request>()
{
  return &::messages_fr3::srv::rosidl_typesupport_cpp::SetParam_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, messages_fr3, srv, SetParam_Request)() {
  return get_message_type_support_handle<messages_fr3::srv::SetParam_Request>();
}
...
static const _SetParam_Response_type_support_symbol_names_t _SetParam_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages_fr3, srv, SetParam_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, messages_fr3, srv, SetParam_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<messages_fr3::srv::SetParam_Response>()
{
  return &::messages_fr3::srv::rosidl_typesupport_cpp::SetParam_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, messages_fr3, srv, SetParam_Response)() {
  return get_message_type_support_handle<messages_fr3::srv::SetParam_Response>();
}
...
static const _SetParam_type_support_symbol_names_t _SetParam_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages_fr3, srv, SetParam)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, messages_fr3, srv, SetParam)),
  }
};
...
get_service_type_support_handle<messages_fr3::srv::SetParam>()
{
  return &::messages_fr3::srv::rosidl_typesupport_cpp::SetParam_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, messages_fr3, srv, SetParam)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<messages_fr3::srv::SetParam>();
}
