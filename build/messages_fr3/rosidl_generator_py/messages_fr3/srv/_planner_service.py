...
class Metaclass_PlannerService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'messages_fr3.srv.PlannerService')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from messages_fr3.srv import _planner_service
...
class PlannerService(metaclass=Metaclass_PlannerService):
    from messages_fr3.srv._planner_service import PlannerService_Request as Request
    from messages_fr3.srv._planner_service import PlannerService_Response as Response
