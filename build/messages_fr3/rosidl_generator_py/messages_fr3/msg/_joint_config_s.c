...
bool messages_fr3__msg__joint_config__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("messages_fr3.msg._joint_config.JointConfig", full_classname_dest, 42) == 0);
  }
  messages_fr3__msg__JointConfig * ros_message = _ros_message;
  {  // joint1
...
{
  /* NOTE(esteve): Call constructor of JointConfig */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("messages_fr3.msg._joint_config");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointConfig");
