...
#include "messages_fr3/srv/detail/planner_service__rosidl_typesupport_fastrtps_c.h"
...
using _PlannerService_Request__ros_msg_type = messages_fr3__srv__PlannerService_Request;
...
size_t get_serialized_size_messages_fr3__srv__PlannerService_Request(
  const void * untyped_ros_message,
...
static uint32_t _PlannerService_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_messages_fr3__srv__PlannerService_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_messages_fr3
size_t max_serialized_size_messages_fr3__srv__PlannerService_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = messages_fr3__srv__PlannerService_Request;
    is_plain =
      (
...
static size_t _PlannerService_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_messages_fr3__srv__PlannerService_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, messages_fr3, srv, PlannerService_Request)() {
...
using _PlannerService_Response__ros_msg_type = messages_fr3__srv__PlannerService_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_messages_fr3
size_t get_serialized_size_messages_fr3__srv__PlannerService_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlannerService_Response__ros_msg_type * ros_message = static_cast<const _PlannerService_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_messages_fr3__srv__PlannerService_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_messages_fr3
size_t max_serialized_size_messages_fr3__srv__PlannerService_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = messages_fr3__srv__PlannerService_Response;
    is_plain =
      (
...
static size_t _PlannerService_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_messages_fr3__srv__PlannerService_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, messages_fr3, srv, PlannerService_Response)() {
...
// already included above
// #include "messages_fr3/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "messages_fr3/srv/planner_service.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, messages_fr3, srv, PlannerService)() {
