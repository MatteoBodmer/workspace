...
#include "messages_fr3/msg/detail/joint_config__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const messages_fr3::msg::JointConfig & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  messages_fr3::msg::JointConfig & ros_message)
{
  // Member: joint1
  cdr >> ros_message.joint1;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_messages_fr3
max_serialized_size_JointConfig(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = messages_fr3::msg::JointConfig;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const messages_fr3::msg::JointConfig *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<messages_fr3::msg::JointConfig *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _JointConfig__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const messages_fr3::msg::JointConfig *>(
...
static size_t _JointConfig__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_JointConfig(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _JointConfig__callbacks = {
  "messages_fr3::msg",
  "JointConfig",
...
static rosidl_message_type_support_t _JointConfig__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_JointConfig__callbacks,
...
{
  return &messages_fr3::msg::typesupport_fastrtps_cpp::_JointConfig__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages_fr3, msg, JointConfig)() {
  return &messages_fr3::msg::typesupport_fastrtps_cpp::_JointConfig__handle;
}
